 ...
 */
public class FetchTopRatedMovies {
...
//                https://api.themoviedb.org/3/movie/271110/videos?api_key=Constants.API_KEY
            URL url = new URL("https://api.themoviedb.org/3/movie/top_rated?api_key="+ Constants.API_KEY+"&page="+pageOffset);
...
//                            .load("http://image.tmdb.org/t/p/w342/" + movie.getPoster_path());
            ...
            e.printStackTrace();
            Log.i(FetchTopRatedMovies.class.getSimpleName(), e.getLocalizedMessage());
        }
    }
